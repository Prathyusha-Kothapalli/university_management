...
@router.get("/entity-121", response_model=List[HostelsSchemaEntity121Response])
...
@router.get("/entity-121/{entity_id}", response_model=HostelsSchemaEntity121Response)
...
@router.post("/entity-121", response_model=HostelsSchemaEntity121Response, status_code=201)
def create_entity_121(payload: HostelsSchemaEntity121Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_121(payload)

@router.get("/entity-122", response_model=List[HostelsSchemaEntity122Response])
...
@router.get("/entity-122/{entity_id}", response_model=HostelsSchemaEntity122Response)
...
@router.post("/entity-122", response_model=HostelsSchemaEntity122Response, status_code=201)
def create_entity_122(payload: HostelsSchemaEntity122Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_122(payload)

@router.get("/entity-123", response_model=List[HostelsSchemaEntity123Response])
...
@router.get("/entity-123/{entity_id}", response_model=HostelsSchemaEntity123Response)
...
@router.post("/entity-123", response_model=HostelsSchemaEntity123Response, status_code=201)
def create_entity_123(payload: HostelsSchemaEntity123Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_123(payload)

@router.get("/entity-124", response_model=List[HostelsSchemaEntity124Response])
...
@router.get("/entity-124/{entity_id}", response_model=HostelsSchemaEntity124Response)
...
@router.post("/entity-124", response_model=HostelsSchemaEntity124Response, status_code=201)
def create_entity_124(payload: HostelsSchemaEntity124Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_124(payload)

@router.get("/entity-125", response_model=List[HostelsSchemaEntity125Response])
...
@router.get("/entity-125/{entity_id}", response_model=HostelsSchemaEntity125Response)
...
@router.post("/entity-125", response_model=HostelsSchemaEntity125Response, status_code=201)
def create_entity_125(payload: HostelsSchemaEntity125Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_125(payload)

@router.get("/entity-126", response_model=List[HostelsSchemaEntity126Response])
...
@router.get("/entity-126/{entity_id}", response_model=HostelsSchemaEntity126Response)
...
@router.post("/entity-126", response_model=HostelsSchemaEntity126Response, status_code=201)
def create_entity_126(payload: HostelsSchemaEntity126Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_126(payload)

@router.get("/entity-127", response_model=List[HostelsSchemaEntity127Response])
...
@router.get("/entity-127/{entity_id}", response_model=HostelsSchemaEntity127Response)
...
@router.post("/entity-127", response_model=HostelsSchemaEntity127Response, status_code=201)
def create_entity_127(payload: HostelsSchemaEntity127Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_127(payload)

@router.get("/entity-128", response_model=List[HostelsSchemaEntity128Response])
...
@router.get("/entity-128/{entity_id}", response_model=HostelsSchemaEntity128Response)
...
@router.post("/entity-128", response_model=HostelsSchemaEntity128Response, status_code=201)
def create_entity_128(payload: HostelsSchemaEntity128Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_128(payload)

@router.get("/entity-129", response_model=List[HostelsSchemaEntity129Response])
...
@router.get("/entity-129/{entity_id}", response_model=HostelsSchemaEntity129Response)
...
@router.post("/entity-129", response_model=HostelsSchemaEntity129Response, status_code=201)
def create_entity_129(payload: HostelsSchemaEntity129Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_129(payload)

@router.get("/entity-130", response_model=List[HostelsSchemaEntity130Response])
...
@router.get("/entity-130/{entity_id}", response_model=HostelsSchemaEntity130Response)
...
@router.post("/entity-130", response_model=HostelsSchemaEntity130Response, status_code=201)
def create_entity_130(payload: HostelsSchemaEntity130Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_130(payload)

@router.get("/entity-131", response_model=List[HostelsSchemaEntity131Response])
...
@router.get("/entity-131/{entity_id}", response_model=HostelsSchemaEntity131Response)
...
@router.post("/entity-131", response_model=HostelsSchemaEntity131Response, status_code=201)
def create_entity_131(payload: HostelsSchemaEntity131Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_131(payload)

@router.get("/entity-132", response_model=List[HostelsSchemaEntity132Response])
...
@router.get("/entity-132/{entity_id}", response_model=HostelsSchemaEntity132Response)
...
@router.post("/entity-132", response_model=HostelsSchemaEntity132Response, status_code=201)
def create_entity_132(payload: HostelsSchemaEntity132Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_132(payload)

@router.get("/entity-133", response_model=List[HostelsSchemaEntity133Response])
...
@router.get("/entity-133/{entity_id}", response_model=HostelsSchemaEntity133Response)
...
@router.post("/entity-133", response_model=HostelsSchemaEntity133Response, status_code=201)
def create_entity_133(payload: HostelsSchemaEntity133Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_133(payload)

@router.get("/entity-134", response_model=List[HostelsSchemaEntity134Response])
...
@router.get("/entity-134/{entity_id}", response_model=HostelsSchemaEntity134Response)
...
@router.post("/entity-134", response_model=HostelsSchemaEntity134Response, status_code=201)
def create_entity_134(payload: HostelsSchemaEntity134Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_134(payload)

@router.get("/entity-135", response_model=List[HostelsSchemaEntity135Response])
...
@router.get("/entity-135/{entity_id}", response_model=HostelsSchemaEntity135Response)
...
@router.post("/entity-135", response_model=HostelsSchemaEntity135Response, status_code=201)
def create_entity_135(payload: HostelsSchemaEntity135Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_135(payload)

@router.get("/entity-136", response_model=List[HostelsSchemaEntity136Response])
...
@router.get("/entity-136/{entity_id}", response_model=HostelsSchemaEntity136Response)
...
@router.post("/entity-136", response_model=HostelsSchemaEntity136Response, status_code=201)
def create_entity_136(payload: HostelsSchemaEntity136Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_136(payload)

@router.get("/entity-137", response_model=List[HostelsSchemaEntity137Response])
...
@router.get("/entity-137/{entity_id}", response_model=HostelsSchemaEntity137Response)
...
@router.post("/entity-137", response_model=HostelsSchemaEntity137Response, status_code=201)
def create_entity_137(payload: HostelsSchemaEntity137Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_137(payload)

@router.get("/entity-138", response_model=List[HostelsSchemaEntity138Response])
...
@router.get("/entity-138/{entity_id}", response_model=HostelsSchemaEntity138Response)
...
@router.post("/entity-138", response_model=HostelsSchemaEntity138Response, status_code=201)
def create_entity_138(payload: HostelsSchemaEntity138Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_138(payload)

@router.get("/entity-139", response_model=List[HostelsSchemaEntity139Response])
...
@router.get("/entity-139/{entity_id}", response_model=HostelsSchemaEntity139Response)
...
@router.post("/entity-139", response_model=HostelsSchemaEntity139Response, status_code=201)
def create_entity_139(payload: HostelsSchemaEntity139Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_139(payload)

@router.get("/entity-140", response_model=List[HostelsSchemaEntity140Response])
...
@router.get("/entity-140/{entity_id}", response_model=HostelsSchemaEntity140Response)
...
@router.post("/entity-140", response_model=HostelsSchemaEntity140Response, status_code=201)
def create_entity_140(payload: HostelsSchemaEntity140Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_140(payload)

@router.get("/entity-141", response_model=List[HostelsSchemaEntity141Response])
...
@router.get("/entity-141/{entity_id}", response_model=HostelsSchemaEntity141Response)
...
@router.post("/entity-141", response_model=HostelsSchemaEntity141Response, status_code=201)
def create_entity_141(payload: HostelsSchemaEntity141Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_141(payload)

@router.get("/entity-142", response_model=List[HostelsSchemaEntity142Response])
...
@router.get("/entity-142/{entity_id}", response_model=HostelsSchemaEntity142Response)
...
@router.post("/entity-142", response_model=HostelsSchemaEntity142Response, status_code=201)
def create_entity_142(payload: HostelsSchemaEntity142Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_142(payload)

@router.get("/entity-143", response_model=List[HostelsSchemaEntity143Response])
...
@router.get("/entity-143/{entity_id}", response_model=HostelsSchemaEntity143Response)
...
@router.post("/entity-143", response_model=HostelsSchemaEntity143Response, status_code=201)
def create_entity_143(payload: HostelsSchemaEntity143Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_143(payload)

@router.get("/entity-144", response_model=List[HostelsSchemaEntity144Response])
...
@router.get("/entity-144/{entity_id}", response_model=HostelsSchemaEntity144Response)
...
@router.post("/entity-144", response_model=HostelsSchemaEntity144Response, status_code=201)
def create_entity_144(payload: HostelsSchemaEntity144Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_144(payload)

@router.get("/entity-145", response_model=List[HostelsSchemaEntity145Response])
...
@router.get("/entity-145/{entity_id}", response_model=HostelsSchemaEntity145Response)
...
@router.post("/entity-145", response_model=HostelsSchemaEntity145Response, status_code=201)
def create_entity_145(payload: HostelsSchemaEntity145Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_145(payload)

@router.get("/entity-146", response_model=List[HostelsSchemaEntity146Response])
...
@router.get("/entity-146/{entity_id}", response_model=HostelsSchemaEntity146Response)
...
@router.post("/entity-146", response_model=HostelsSchemaEntity146Response, status_code=201)
def create_entity_146(payload: HostelsSchemaEntity146Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_146(payload)

@router.get("/entity-147", response_model=List[HostelsSchemaEntity147Response])
...
@router.get("/entity-147/{entity_id}", response_model=HostelsSchemaEntity147Response)
...
@router.post("/entity-147", response_model=HostelsSchemaEntity147Response, status_code=201)
def create_entity_147(payload: HostelsSchemaEntity147Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_147(payload)

@router.get("/entity-148", response_model=List[HostelsSchemaEntity148Response])
...
@router.get("/entity-148/{entity_id}", response_model=HostelsSchemaEntity148Response)
...
@router.post("/entity-148", response_model=HostelsSchemaEntity148Response, status_code=201)
def create_entity_148(payload: HostelsSchemaEntity148Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_148(payload)

@router.get("/entity-149", response_model=List[HostelsSchemaEntity149Response])
...
@router.get("/entity-149/{entity_id}", response_model=HostelsSchemaEntity149Response)
...
@router.post("/entity-149", response_model=HostelsSchemaEntity149Response, status_code=201)
def create_entity_149(payload: HostelsSchemaEntity149Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_149(payload)

@router.get("/entity-150", response_model=List[HostelsSchemaEntity150Response])
...
@router.get("/entity-150/{entity_id}", response_model=HostelsSchemaEntity150Response)
...
@router.post("/entity-150", response_model=HostelsSchemaEntity150Response, status_code=201)
def create_entity_150(payload: HostelsSchemaEntity150Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_150(payload)

@router.get("/entity-151", response_model=List[HostelsSchemaEntity151Response])
...
@router.get("/entity-151/{entity_id}", response_model=HostelsSchemaEntity151Response)
...
@router.post("/entity-151", response_model=HostelsSchemaEntity151Response, status_code=201)
def create_entity_151(payload: HostelsSchemaEntity151Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_151(payload)

@router.get("/entity-152", response_model=List[HostelsSchemaEntity152Response])
...
@router.get("/entity-152/{entity_id}", response_model=HostelsSchemaEntity152Response)
...
@router.post("/entity-152", response_model=HostelsSchemaEntity152Response, status_code=201)
def create_entity_152(payload: HostelsSchemaEntity152Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_152(payload)

@router.get("/entity-153", response_model=List[HostelsSchemaEntity153Response])
...
@router.get("/entity-153/{entity_id}", response_model=HostelsSchemaEntity153Response)
...
@router.post("/entity-153", response_model=HostelsSchemaEntity153Response, status_code=201)
def create_entity_153(payload: HostelsSchemaEntity153Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_153(payload)

@router.get("/entity-154", response_model=List[HostelsSchemaEntity154Response])
...
@router.get("/entity-154/{entity_id}", response_model=HostelsSchemaEntity154Response)
...
@router.post("/entity-154", response_model=HostelsSchemaEntity154Response, status_code=201)
def create_entity_154(payload: HostelsSchemaEntity154Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_154(payload)

@router.get("/entity-155", response_model=List[HostelsSchemaEntity155Response])
...
@router.get("/entity-155/{entity_id}", response_model=HostelsSchemaEntity155Response)
...
@router.post("/entity-155", response_model=HostelsSchemaEntity155Response, status_code=201)
def create_entity_155(payload: HostelsSchemaEntity155Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_155(payload)

@router.get("/entity-156", response_model=List[HostelsSchemaEntity156Response])
...
@router.get("/entity-156/{entity_id}", response_model=HostelsSchemaEntity156Response)
...
@router.post("/entity-156", response_model=HostelsSchemaEntity156Response, status_code=201)
def create_entity_156(payload: HostelsSchemaEntity156Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_156(payload)

@router.get("/entity-157", response_model=List[HostelsSchemaEntity157Response])
...
@router.get("/entity-157/{entity_id}", response_model=HostelsSchemaEntity157Response)
...
@router.post("/entity-157", response_model=HostelsSchemaEntity157Response, status_code=201)
def create_entity_157(payload: HostelsSchemaEntity157Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_157(payload)

@router.get("/entity-158", response_model=List[HostelsSchemaEntity158Response])
...
@router.get("/entity-158/{entity_id}", response_model=HostelsSchemaEntity158Response)
...
@router.post("/entity-158", response_model=HostelsSchemaEntity158Response, status_code=201)
def create_entity_158(payload: HostelsSchemaEntity158Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_158(payload)

@router.get("/entity-159", response_model=List[HostelsSchemaEntity159Response])
...
@router.get("/entity-159/{entity_id}", response_model=HostelsSchemaEntity159Response)
...
@router.post("/entity-159", response_model=HostelsSchemaEntity159Response, status_code=201)
def create_entity_159(payload: HostelsSchemaEntity159Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_159(payload)

@router.get("/entity-160", response_model=List[HostelsSchemaEntity160Response])
...
@router.get("/entity-160/{entity_id}", response_model=HostelsSchemaEntity160Response)
...
@router.post("/entity-160", response_model=HostelsSchemaEntity160Response, status_code=201)
def create_entity_160(payload: HostelsSchemaEntity160Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_160(payload)

@router.get("/entity-161", response_model=List[HostelsSchemaEntity161Response])
...
@router.get("/entity-161/{entity_id}", response_model=HostelsSchemaEntity161Response)
...
@router.post("/entity-161", response_model=HostelsSchemaEntity161Response, status_code=201)
def create_entity_161(payload: HostelsSchemaEntity161Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_161(payload)

@router.get("/entity-162", response_model=List[HostelsSchemaEntity162Response])
...
@router.get("/entity-162/{entity_id}", response_model=HostelsSchemaEntity162Response)
...
@router.post("/entity-162", response_model=HostelsSchemaEntity162Response, status_code=201)
def create_entity_162(payload: HostelsSchemaEntity162Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_162(payload)

@router.get("/entity-163", response_model=List[HostelsSchemaEntity163Response])
...
@router.get("/entity-163/{entity_id}", response_model=HostelsSchemaEntity163Response)
...
@router.post("/entity-163", response_model=HostelsSchemaEntity163Response, status_code=201)
def create_entity_163(payload: HostelsSchemaEntity163Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_163(payload)

@router.get("/entity-164", response_model=List[HostelsSchemaEntity164Response])
...
@router.get("/entity-164/{entity_id}", response_model=HostelsSchemaEntity164Response)
...
@router.post("/entity-164", response_model=HostelsSchemaEntity164Response, status_code=201)
def create_entity_164(payload: HostelsSchemaEntity164Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_164(payload)

@router.get("/entity-165", response_model=List[HostelsSchemaEntity165Response])
...
@router.get("/entity-165/{entity_id}", response_model=HostelsSchemaEntity165Response)
...
@router.post("/entity-165", response_model=HostelsSchemaEntity165Response, status_code=201)
def create_entity_165(payload: HostelsSchemaEntity165Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_165(payload)

@router.get("/entity-166", response_model=List[HostelsSchemaEntity166Response])
...
@router.get("/entity-166/{entity_id}", response_model=HostelsSchemaEntity166Response)
...
@router.post("/entity-166", response_model=HostelsSchemaEntity166Response, status_code=201)
def create_entity_166(payload: HostelsSchemaEntity166Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_166(payload)

@router.get("/entity-167", response_model=List[HostelsSchemaEntity167Response])
...
@router.get("/entity-167/{entity_id}", response_model=HostelsSchemaEntity167Response)
...
@router.post("/entity-167", response_model=HostelsSchemaEntity167Response, status_code=201)
def create_entity_167(payload: HostelsSchemaEntity167Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_167(payload)

@router.get("/entity-168", response_model=List[HostelsSchemaEntity168Response])
...
@router.get("/entity-168/{entity_id}", response_model=HostelsSchemaEntity168Response)
...
@router.post("/entity-168", response_model=HostelsSchemaEntity168Response, status_code=201)
def create_entity_168(payload: HostelsSchemaEntity168Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_168(payload)

@router.get("/entity-169", response_model=List[HostelsSchemaEntity169Response])
...
@router.get("/entity-169/{entity_id}", response_model=HostelsSchemaEntity169Response)
...
@router.post("/entity-169", response_model=HostelsSchemaEntity169Response, status_code=201)
def create_entity_169(payload: HostelsSchemaEntity169Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_169(payload)

@router.get("/entity-170", response_model=List[HostelsSchemaEntity170Response])
...
@router.get("/entity-170/{entity_id}", response_model=HostelsSchemaEntity170Response)
...
@router.post("/entity-170", response_model=HostelsSchemaEntity170Response, status_code=201)
def create_entity_170(payload: HostelsSchemaEntity170Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_170(payload)

@router.get("/entity-171", response_model=List[HostelsSchemaEntity171Response])
...
@router.get("/entity-171/{entity_id}", response_model=HostelsSchemaEntity171Response)
...
@router.post("/entity-171", response_model=HostelsSchemaEntity171Response, status_code=201)
def create_entity_171(payload: HostelsSchemaEntity171Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_171(payload)

@router.get("/entity-172", response_model=List[HostelsSchemaEntity172Response])
...
@router.get("/entity-172/{entity_id}", response_model=HostelsSchemaEntity172Response)
...
@router.post("/entity-172", response_model=HostelsSchemaEntity172Response, status_code=201)
def create_entity_172(payload: HostelsSchemaEntity172Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_172(payload)

@router.get("/entity-173", response_model=List[HostelsSchemaEntity173Response])
...
@router.get("/entity-173/{entity_id}", response_model=HostelsSchemaEntity173Response)
...
@router.post("/entity-173", response_model=HostelsSchemaEntity173Response, status_code=201)
def create_entity_173(payload: HostelsSchemaEntity173Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_173(payload)

@router.get("/entity-174", response_model=List[HostelsSchemaEntity174Response])
...
@router.get("/entity-174/{entity_id}", response_model=HostelsSchemaEntity174Response)
...
@router.post("/entity-174", response_model=HostelsSchemaEntity174Response, status_code=201)
def create_entity_174(payload: HostelsSchemaEntity174Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_174(payload)

@router.get("/entity-175", response_model=List[HostelsSchemaEntity175Response])
...
@router.get("/entity-175/{entity_id}", response_model=HostelsSchemaEntity175Response)
...
@router.post("/entity-175", response_model=HostelsSchemaEntity175Response, status_code=201)
def create_entity_175(payload: HostelsSchemaEntity175Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_175(payload)

@router.get("/entity-176", response_model=List[HostelsSchemaEntity176Response])
...
@router.get("/entity-176/{entity_id}", response_model=HostelsSchemaEntity176Response)
...
@router.post("/entity-176", response_model=HostelsSchemaEntity176Response, status_code=201)
def create_entity_176(payload: HostelsSchemaEntity176Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_176(payload)

@router.get("/entity-177", response_model=List[HostelsSchemaEntity177Response])
...
@router.get("/entity-177/{entity_id}", response_model=HostelsSchemaEntity177Response)
...
@router.post("/entity-177", response_model=HostelsSchemaEntity177Response, status_code=201)
def create_entity_177(payload: HostelsSchemaEntity177Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_177(payload)

@router.get("/entity-178", response_model=List[HostelsSchemaEntity178Response])
...
@router.get("/entity-178/{entity_id}", response_model=HostelsSchemaEntity178Response)
...
@router.post("/entity-178", response_model=HostelsSchemaEntity178Response, status_code=201)
def create_entity_178(payload: HostelsSchemaEntity178Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_178(payload)

@router.get("/entity-179", response_model=List[HostelsSchemaEntity179Response])
...
@router.get("/entity-179/{entity_id}", response_model=HostelsSchemaEntity179Response)
...
@router.post("/entity-179", response_model=HostelsSchemaEntity179Response, status_code=201)
def create_entity_179(payload: HostelsSchemaEntity179Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_179(payload)

@router.get("/entity-180", response_model=List[HostelsSchemaEntity180Response])
...
@router.get("/entity-180/{entity_id}", response_model=HostelsSchemaEntity180Response)
...
@router.post("/entity-180", response_model=HostelsSchemaEntity180Response, status_code=201)
def create_entity_180(payload: HostelsSchemaEntity180Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_180(payload)

@router.get("/entity-181", response_model=List[HostelsSchemaEntity181Response])
...
@router.get("/entity-181/{entity_id}", response_model=HostelsSchemaEntity181Response)
...
@router.post("/entity-181", response_model=HostelsSchemaEntity181Response, status_code=201)
def create_entity_181(payload: HostelsSchemaEntity181Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_181(payload)

@router.get("/entity-182", response_model=List[HostelsSchemaEntity182Response])
...
@router.get("/entity-182/{entity_id}", response_model=HostelsSchemaEntity182Response)
...
@router.post("/entity-182", response_model=HostelsSchemaEntity182Response, status_code=201)
def create_entity_182(payload: HostelsSchemaEntity182Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_182(payload)

@router.get("/entity-183", response_model=List[HostelsSchemaEntity183Response])
...
@router.get("/entity-183/{entity_id}", response_model=HostelsSchemaEntity183Response)
...
@router.post("/entity-183", response_model=HostelsSchemaEntity183Response, status_code=201)
def create_entity_183(payload: HostelsSchemaEntity183Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_183(payload)

@router.get("/entity-184", response_model=List[HostelsSchemaEntity184Response])
...
@router.get("/entity-184/{entity_id}", response_model=HostelsSchemaEntity184Response)
...
@router.post("/entity-184", response_model=HostelsSchemaEntity184Response, status_code=201)
def create_entity_184(payload: HostelsSchemaEntity184Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_184(payload)

@router.get("/entity-185", response_model=List[HostelsSchemaEntity185Response])
...
@router.get("/entity-185/{entity_id}", response_model=HostelsSchemaEntity185Response)
...
@router.post("/entity-185", response_model=HostelsSchemaEntity185Response, status_code=201)
def create_entity_185(payload: HostelsSchemaEntity185Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_185(payload)

@router.get("/entity-186", response_model=List[HostelsSchemaEntity186Response])
...
@router.get("/entity-186/{entity_id}", response_model=HostelsSchemaEntity186Response)
...
@router.post("/entity-186", response_model=HostelsSchemaEntity186Response, status_code=201)
def create_entity_186(payload: HostelsSchemaEntity186Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_186(payload)

@router.get("/entity-187", response_model=List[HostelsSchemaEntity187Response])
...
@router.get("/entity-187/{entity_id}", response_model=HostelsSchemaEntity187Response)
...
@router.post("/entity-187", response_model=HostelsSchemaEntity187Response, status_code=201)
def create_entity_187(payload: HostelsSchemaEntity187Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_187(payload)

@router.get("/entity-188", response_model=List[HostelsSchemaEntity188Response])
...
@router.get("/entity-188/{entity_id}", response_model=HostelsSchemaEntity188Response)
...
@router.post("/entity-188", response_model=HostelsSchemaEntity188Response, status_code=201)
def create_entity_188(payload: HostelsSchemaEntity188Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_188(payload)

@router.get("/entity-189", response_model=List[HostelsSchemaEntity189Response])
...
@router.get("/entity-189/{entity_id}", response_model=HostelsSchemaEntity189Response)
...
@router.post("/entity-189", response_model=HostelsSchemaEntity189Response, status_code=201)
def create_entity_189(payload: HostelsSchemaEntity189Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_189(payload)

@router.get("/entity-190", response_model=List[HostelsSchemaEntity190Response])
...
@router.get("/entity-190/{entity_id}", response_model=HostelsSchemaEntity190Response)
...
@router.post("/entity-190", response_model=HostelsSchemaEntity190Response, status_code=201)
def create_entity_190(payload: HostelsSchemaEntity190Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_190(payload)

@router.get("/entity-191", response_model=List[HostelsSchemaEntity191Response])
...
@router.get("/entity-191/{entity_id}", response_model=HostelsSchemaEntity191Response)
...
@router.post("/entity-191", response_model=HostelsSchemaEntity191Response, status_code=201)
def create_entity_191(payload: HostelsSchemaEntity191Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_191(payload)

@router.get("/entity-192", response_model=List[HostelsSchemaEntity192Response])
...
@router.get("/entity-192/{entity_id}", response_model=HostelsSchemaEntity192Response)
...
@router.post("/entity-192", response_model=HostelsSchemaEntity192Response, status_code=201)
def create_entity_192(payload: HostelsSchemaEntity192Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_192(payload)

@router.get("/entity-193", response_model=List[HostelsSchemaEntity193Response])
...
@router.get("/entity-193/{entity_id}", response_model=HostelsSchemaEntity193Response)
...
@router.post("/entity-193", response_model=HostelsSchemaEntity193Response, status_code=201)
def create_entity_193(payload: HostelsSchemaEntity193Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_193(payload)

@router.get("/entity-194", response_model=List[HostelsSchemaEntity194Response])
...
@router.get("/entity-194/{entity_id}", response_model=HostelsSchemaEntity194Response)
...
@router.post("/entity-194", response_model=HostelsSchemaEntity194Response, status_code=201)
def create_entity_194(payload: HostelsSchemaEntity194Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_194(payload)

@router.get("/entity-195", response_model=List[HostelsSchemaEntity195Response])
...
@router.get("/entity-195/{entity_id}", response_model=HostelsSchemaEntity195Response)
...
@router.post("/entity-195", response_model=HostelsSchemaEntity195Response, status_code=201)
def create_entity_195(payload: HostelsSchemaEntity195Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_195(payload)

@router.get("/entity-196", response_model=List[HostelsSchemaEntity196Response])
...
@router.get("/entity-196/{entity_id}", response_model=HostelsSchemaEntity196Response)
...
@router.post("/entity-196", response_model=HostelsSchemaEntity196Response, status_code=201)
def create_entity_196(payload: HostelsSchemaEntity196Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_196(payload)

@router.get("/entity-197", response_model=List[HostelsSchemaEntity197Response])
...
@router.get("/entity-197/{entity_id}", response_model=HostelsSchemaEntity197Response)
...
@router.post("/entity-197", response_model=HostelsSchemaEntity197Response, status_code=201)
def create_entity_197(payload: HostelsSchemaEntity197Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_197(payload)

@router.get("/entity-198", response_model=List[HostelsSchemaEntity198Response])
...
@router.get("/entity-198/{entity_id}", response_model=HostelsSchemaEntity198Response)
...
@router.post("/entity-198", response_model=HostelsSchemaEntity198Response, status_code=201)
def create_entity_198(payload: HostelsSchemaEntity198Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_198(payload)

@router.get("/entity-199", response_model=List[HostelsSchemaEntity199Response])
...
@router.get("/entity-199/{entity_id}", response_model=HostelsSchemaEntity199Response)
...
@router.post("/entity-199", response_model=HostelsSchemaEntity199Response, status_code=201)
def create_entity_199(payload: HostelsSchemaEntity199Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_199(payload)

@router.get("/entity-200", response_model=List[HostelsSchemaEntity200Response])
...
@router.get("/entity-200/{entity_id}", response_model=HostelsSchemaEntity200Response)
...
@router.post("/entity-200", response_model=HostelsSchemaEntity200Response, status_code=201)
def create_entity_200(payload: HostelsSchemaEntity200Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_200(payload)

@router.get("/entity-201", response_model=List[HostelsSchemaEntity201Response])
...
@router.get("/entity-201/{entity_id}", response_model=HostelsSchemaEntity201Response)
...
@router.post("/entity-201", response_model=HostelsSchemaEntity201Response, status_code=201)
def create_entity_201(payload: HostelsSchemaEntity201Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_201(payload)

@router.get("/entity-202", response_model=List[HostelsSchemaEntity202Response])
...
@router.get("/entity-202/{entity_id}", response_model=HostelsSchemaEntity202Response)
...
@router.post("/entity-202", response_model=HostelsSchemaEntity202Response, status_code=201)
def create_entity_202(payload: HostelsSchemaEntity202Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_202(payload)

@router.get("/entity-203", response_model=List[HostelsSchemaEntity203Response])
...
@router.get("/entity-203/{entity_id}", response_model=HostelsSchemaEntity203Response)
...
@router.post("/entity-203", response_model=HostelsSchemaEntity203Response, status_code=201)
def create_entity_203(payload: HostelsSchemaEntity203Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_203(payload)

@router.get("/entity-204", response_model=List[HostelsSchemaEntity204Response])
...
@router.get("/entity-204/{entity_id}", response_model=HostelsSchemaEntity204Response)
...
@router.post("/entity-204", response_model=HostelsSchemaEntity204Response, status_code=201)
def create_entity_204(payload: HostelsSchemaEntity204Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_204(payload)

@router.get("/entity-205", response_model=List[HostelsSchemaEntity205Response])
...
@router.get("/entity-205/{entity_id}", response_model=HostelsSchemaEntity205Response)
...
@router.post("/entity-205", response_model=HostelsSchemaEntity205Response, status_code=201)
def create_entity_205(payload: HostelsSchemaEntity205Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_205(payload)

@router.get("/entity-206", response_model=List[HostelsSchemaEntity206Response])
...
@router.get("/entity-206/{entity_id}", response_model=HostelsSchemaEntity206Response)
...
@router.post("/entity-206", response_model=HostelsSchemaEntity206Response, status_code=201)
def create_entity_206(payload: HostelsSchemaEntity206Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_206(payload)

@router.get("/entity-207", response_model=List[HostelsSchemaEntity207Response])
...
@router.get("/entity-207/{entity_id}", response_model=HostelsSchemaEntity207Response)
...
@router.post("/entity-207", response_model=HostelsSchemaEntity207Response, status_code=201)
def create_entity_207(payload: HostelsSchemaEntity207Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_207(payload)

@router.get("/entity-208", response_model=List[HostelsSchemaEntity208Response])
...
@router.get("/entity-208/{entity_id}", response_model=HostelsSchemaEntity208Response)
...
@router.post("/entity-208", response_model=HostelsSchemaEntity208Response, status_code=201)
def create_entity_208(payload: HostelsSchemaEntity208Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_208(payload)

@router.get("/entity-209", response_model=List[HostelsSchemaEntity209Response])
...
@router.get("/entity-209/{entity_id}", response_model=HostelsSchemaEntity209Response)
...
@router.post("/entity-209", response_model=HostelsSchemaEntity209Response, status_code=201)
def create_entity_209(payload: HostelsSchemaEntity209Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_209(payload)

@router.get("/entity-210", response_model=List[HostelsSchemaEntity210Response])
...
@router.get("/entity-210/{entity_id}", response_model=HostelsSchemaEntity210Response)
...
@router.post("/entity-210", response_model=HostelsSchemaEntity210Response, status_code=201)
def create_entity_210(payload: HostelsSchemaEntity210Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_210(payload)

@router.get("/entity-211", response_model=List[HostelsSchemaEntity211Response])
...
@router.get("/entity-211/{entity_id}", response_model=HostelsSchemaEntity211Response)
...
@router.post("/entity-211", response_model=HostelsSchemaEntity211Response, status_code=201)
def create_entity_211(payload: HostelsSchemaEntity211Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_211(payload)

@router.get("/entity-212", response_model=List[HostelsSchemaEntity212Response])
...
@router.get("/entity-212/{entity_id}", response_model=HostelsSchemaEntity212Response)
...
@router.post("/entity-212", response_model=HostelsSchemaEntity212Response, status_code=201)
def create_entity_212(payload: HostelsSchemaEntity212Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_212(payload)

@router.get("/entity-213", response_model=List[HostelsSchemaEntity213Response])
...
@router.get("/entity-213/{entity_id}", response_model=HostelsSchemaEntity213Response)
...
@router.post("/entity-213", response_model=HostelsSchemaEntity213Response, status_code=201)
def create_entity_213(payload: HostelsSchemaEntity213Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_213(payload)

@router.get("/entity-214", response_model=List[HostelsSchemaEntity214Response])
...
@router.get("/entity-214/{entity_id}", response_model=HostelsSchemaEntity214Response)
...
@router.post("/entity-214", response_model=HostelsSchemaEntity214Response, status_code=201)
def create_entity_214(payload: HostelsSchemaEntity214Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_214(payload)

@router.get("/entity-215", response_model=List[HostelsSchemaEntity215Response])
...
@router.get("/entity-215/{entity_id}", response_model=HostelsSchemaEntity215Response)
...
@router.post("/entity-215", response_model=HostelsSchemaEntity215Response, status_code=201)
def create_entity_215(payload: HostelsSchemaEntity215Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_215(payload)

@router.get("/entity-216", response_model=List[HostelsSchemaEntity216Response])
...
@router.get("/entity-216/{entity_id}", response_model=HostelsSchemaEntity216Response)
...
@router.post("/entity-216", response_model=HostelsSchemaEntity216Response, status_code=201)
def create_entity_216(payload: HostelsSchemaEntity216Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_216(payload)

@router.get("/entity-217", response_model=List[HostelsSchemaEntity217Response])
...
@router.get("/entity-217/{entity_id}", response_model=HostelsSchemaEntity217Response)
...
@router.post("/entity-217", response_model=HostelsSchemaEntity217Response, status_code=201)
def create_entity_217(payload: HostelsSchemaEntity217Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_217(payload)

@router.get("/entity-218", response_model=List[HostelsSchemaEntity218Response])
...
@router.get("/entity-218/{entity_id}", response_model=HostelsSchemaEntity218Response)
...
@router.post("/entity-218", response_model=HostelsSchemaEntity218Response, status_code=201)
def create_entity_218(payload: HostelsSchemaEntity218Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_218(payload)

@router.get("/entity-219", response_model=List[HostelsSchemaEntity219Response])
...
@router.get("/entity-219/{entity_id}", response_model=HostelsSchemaEntity219Response)
...
@router.post("/entity-219", response_model=HostelsSchemaEntity219Response, status_code=201)
def create_entity_219(payload: HostelsSchemaEntity219Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_219(payload)

@router.get("/entity-220", response_model=List[HostelsSchemaEntity220Response])
...
@router.get("/entity-220/{entity_id}", response_model=HostelsSchemaEntity220Response)
...
@router.post("/entity-220", response_model=HostelsSchemaEntity220Response, status_code=201)
def create_entity_220(payload: HostelsSchemaEntity220Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_220(payload)

@router.get("/entity-221", response_model=List[HostelsSchemaEntity221Response])
...
@router.get("/entity-221/{entity_id}", response_model=HostelsSchemaEntity221Response)
...
@router.post("/entity-221", response_model=HostelsSchemaEntity221Response, status_code=201)
def create_entity_221(payload: HostelsSchemaEntity221Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_221(payload)

@router.get("/entity-222", response_model=List[HostelsSchemaEntity222Response])
...
@router.get("/entity-222/{entity_id}", response_model=HostelsSchemaEntity222Response)
...
@router.post("/entity-222", response_model=HostelsSchemaEntity222Response, status_code=201)
def create_entity_222(payload: HostelsSchemaEntity222Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_222(payload)

@router.get("/entity-223", response_model=List[HostelsSchemaEntity223Response])
...
@router.get("/entity-223/{entity_id}", response_model=HostelsSchemaEntity223Response)
...
@router.post("/entity-223", response_model=HostelsSchemaEntity223Response, status_code=201)
def create_entity_223(payload: HostelsSchemaEntity223Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_223(payload)

@router.get("/entity-224", response_model=List[HostelsSchemaEntity224Response])
...
@router.get("/entity-224/{entity_id}", response_model=HostelsSchemaEntity224Response)
...
@router.post("/entity-224", response_model=HostelsSchemaEntity224Response, status_code=201)
def create_entity_224(payload: HostelsSchemaEntity224Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_224(payload)

@router.get("/entity-225", response_model=List[HostelsSchemaEntity225Response])
...
@router.get("/entity-225/{entity_id}", response_model=HostelsSchemaEntity225Response)
...
@router.post("/entity-225", response_model=HostelsSchemaEntity225Response, status_code=201)
def create_entity_225(payload: HostelsSchemaEntity225Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_225(payload)

@router.get("/entity-226", response_model=List[HostelsSchemaEntity226Response])
...
@router.get("/entity-226/{entity_id}", response_model=HostelsSchemaEntity226Response)
...
@router.post("/entity-226", response_model=HostelsSchemaEntity226Response, status_code=201)
def create_entity_226(payload: HostelsSchemaEntity226Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_226(payload)

@router.get("/entity-227", response_model=List[HostelsSchemaEntity227Response])
...
@router.get("/entity-227/{entity_id}", response_model=HostelsSchemaEntity227Response)
...
@router.post("/entity-227", response_model=HostelsSchemaEntity227Response, status_code=201)
def create_entity_227(payload: HostelsSchemaEntity227Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_227(payload)

@router.get("/entity-228", response_model=List[HostelsSchemaEntity228Response])
...
@router.get("/entity-228/{entity_id}", response_model=HostelsSchemaEntity228Response)
...
@router.post("/entity-228", response_model=HostelsSchemaEntity228Response, status_code=201)
def create_entity_228(payload: HostelsSchemaEntity228Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_228(payload)

@router.get("/entity-229", response_model=List[HostelsSchemaEntity229Response])
...
@router.get("/entity-229/{entity_id}", response_model=HostelsSchemaEntity229Response)
...
@router.post("/entity-229", response_model=HostelsSchemaEntity229Response, status_code=201)
def create_entity_229(payload: HostelsSchemaEntity229Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_229(payload)

@router.get("/entity-230", response_model=List[HostelsSchemaEntity230Response])
...
@router.get("/entity-230/{entity_id}", response_model=HostelsSchemaEntity230Response)
...
@router.post("/entity-230", response_model=HostelsSchemaEntity230Response, status_code=201)
def create_entity_230(payload: HostelsSchemaEntity230Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_230(payload)

@router.get("/entity-231", response_model=List[HostelsSchemaEntity231Response])
...
@router.get("/entity-231/{entity_id}", response_model=HostelsSchemaEntity231Response)
...
@router.post("/entity-231", response_model=HostelsSchemaEntity231Response, status_code=201)
def create_entity_231(payload: HostelsSchemaEntity231Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_231(payload)

@router.get("/entity-232", response_model=List[HostelsSchemaEntity232Response])
...
@router.get("/entity-232/{entity_id}", response_model=HostelsSchemaEntity232Response)
...
@router.post("/entity-232", response_model=HostelsSchemaEntity232Response, status_code=201)
def create_entity_232(payload: HostelsSchemaEntity232Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_232(payload)

@router.get("/entity-233", response_model=List[HostelsSchemaEntity233Response])
...
@router.get("/entity-233/{entity_id}", response_model=HostelsSchemaEntity233Response)
...
@router.post("/entity-233", response_model=HostelsSchemaEntity233Response, status_code=201)
def create_entity_233(payload: HostelsSchemaEntity233Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_233(payload)

@router.get("/entity-234", response_model=List[HostelsSchemaEntity234Response])
...
@router.get("/entity-234/{entity_id}", response_model=HostelsSchemaEntity234Response)
...
@router.post("/entity-234", response_model=HostelsSchemaEntity234Response, status_code=201)
def create_entity_234(payload: HostelsSchemaEntity234Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_234(payload)

@router.get("/entity-235", response_model=List[HostelsSchemaEntity235Response])
...
@router.get("/entity-235/{entity_id}", response_model=HostelsSchemaEntity235Response)
...
@router.post("/entity-235", response_model=HostelsSchemaEntity235Response, status_code=201)
def create_entity_235(payload: HostelsSchemaEntity235Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_235(payload)

@router.get("/entity-236", response_model=List[HostelsSchemaEntity236Response])
...
@router.get("/entity-236/{entity_id}", response_model=HostelsSchemaEntity236Response)
...
@router.post("/entity-236", response_model=HostelsSchemaEntity236Response, status_code=201)
def create_entity_236(payload: HostelsSchemaEntity236Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_236(payload)

@router.get("/entity-237", response_model=List[HostelsSchemaEntity237Response])
...
@router.get("/entity-237/{entity_id}", response_model=HostelsSchemaEntity237Response)
...
@router.post("/entity-237", response_model=HostelsSchemaEntity237Response, status_code=201)
def create_entity_237(payload: HostelsSchemaEntity237Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_237(payload)

@router.get("/entity-238", response_model=List[HostelsSchemaEntity238Response])
...
@router.get("/entity-238/{entity_id}", response_model=HostelsSchemaEntity238Response)
...
@router.post("/entity-238", response_model=HostelsSchemaEntity238Response, status_code=201)
def create_entity_238(payload: HostelsSchemaEntity238Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_238(payload)

@router.get("/entity-239", response_model=List[HostelsSchemaEntity239Response])
...
@router.get("/entity-239/{entity_id}", response_model=HostelsSchemaEntity239Response)
...
@router.post("/entity-239", response_model=HostelsSchemaEntity239Response, status_code=201)
def create_entity_239(payload: HostelsSchemaEntity239Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_239(payload)

@router.get("/entity-240", response_model=List[HostelsSchemaEntity240Response])
...
@router.get("/entity-240/{entity_id}", response_model=HostelsSchemaEntity240Response)
...
@router.post("/entity-240", response_model=HostelsSchemaEntity240Response, status_code=201)
def create_entity_240(payload: HostelsSchemaEntity240Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_240(payload)

@router.get("/entity-241", response_model=List[HostelsSchemaEntity241Response])
...
@router.get("/entity-241/{entity_id}", response_model=HostelsSchemaEntity241Response)
...
@router.post("/entity-241", response_model=HostelsSchemaEntity241Response, status_code=201)
def create_entity_241(payload: HostelsSchemaEntity241Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_241(payload)

@router.get("/entity-242", response_model=List[HostelsSchemaEntity242Response])
...
@router.get("/entity-242/{entity_id}", response_model=HostelsSchemaEntity242Response)
...
@router.post("/entity-242", response_model=HostelsSchemaEntity242Response, status_code=201)
def create_entity_242(payload: HostelsSchemaEntity242Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_242(payload)

@router.get("/entity-243", response_model=List[HostelsSchemaEntity243Response])
...
@router.get("/entity-243/{entity_id}", response_model=HostelsSchemaEntity243Response)
...
@router.post("/entity-243", response_model=HostelsSchemaEntity243Response, status_code=201)
def create_entity_243(payload: HostelsSchemaEntity243Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_243(payload)

@router.get("/entity-244", response_model=List[HostelsSchemaEntity244Response])
...
@router.get("/entity-244/{entity_id}", response_model=HostelsSchemaEntity244Response)
...
@router.post("/entity-244", response_model=HostelsSchemaEntity244Response, status_code=201)
def create_entity_244(payload: HostelsSchemaEntity244Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_244(payload)

@router.get("/entity-245", response_model=List[HostelsSchemaEntity245Response])
...
@router.get("/entity-245/{entity_id}", response_model=HostelsSchemaEntity245Response)
...
@router.post("/entity-245", response_model=HostelsSchemaEntity245Response, status_code=201)
def create_entity_245(payload: HostelsSchemaEntity245Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_245(payload)

@router.get("/entity-246", response_model=List[HostelsSchemaEntity246Response])
...
@router.get("/entity-246/{entity_id}", response_model=HostelsSchemaEntity246Response)
...
@router.post("/entity-246", response_model=HostelsSchemaEntity246Response, status_code=201)
def create_entity_246(payload: HostelsSchemaEntity246Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_246(payload)

@router.get("/entity-247", response_model=List[HostelsSchemaEntity247Response])
...
@router.get("/entity-247/{entity_id}", response_model=HostelsSchemaEntity247Response)
...
@router.post("/entity-247", response_model=HostelsSchemaEntity247Response, status_code=201)
def create_entity_247(payload: HostelsSchemaEntity247Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_247(payload)

@router.get("/entity-248", response_model=List[HostelsSchemaEntity248Response])
...
@router.get("/entity-248/{entity_id}", response_model=HostelsSchemaEntity248Response)
...
@router.post("/entity-248", response_model=HostelsSchemaEntity248Response, status_code=201)
def create_entity_248(payload: HostelsSchemaEntity248Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_248(payload)

@router.get("/entity-249", response_model=List[HostelsSchemaEntity249Response])
...
@router.get("/entity-249/{entity_id}", response_model=HostelsSchemaEntity249Response)
...
@router.post("/entity-249", response_model=HostelsSchemaEntity249Response, status_code=201)
def create_entity_249(payload: HostelsSchemaEntity249Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
    return srv.create_entity_249(payload)

@router.get("/entity-250", response_model=List[HostelsSchemaEntity250Response])
...
@router.get("/entity-250/{entity_id}", response_model=HostelsSchemaEntity250Response)
...
@router.post("/entity-250", response_model=HostelsSchemaEntity250Response, status_code=201)
def create_entity_250(payload: HostelsSchemaEntity250Create, db: Session = Depends(get_db)):
    srv = HostelsDomainService(db)
