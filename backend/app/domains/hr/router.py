...
@router.get("/entity-201", response_model=List[HrSchemaEntity201Response])
...
@router.get("/entity-201/{entity_id}", response_model=HrSchemaEntity201Response)
...
@router.post("/entity-201", response_model=HrSchemaEntity201Response, status_code=201)
def create_entity_201(payload: HrSchemaEntity201Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_201(payload)

@router.get("/entity-202", response_model=List[HrSchemaEntity202Response])
...
@router.get("/entity-202/{entity_id}", response_model=HrSchemaEntity202Response)
...
@router.post("/entity-202", response_model=HrSchemaEntity202Response, status_code=201)
def create_entity_202(payload: HrSchemaEntity202Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_202(payload)

@router.get("/entity-203", response_model=List[HrSchemaEntity203Response])
...
@router.get("/entity-203/{entity_id}", response_model=HrSchemaEntity203Response)
...
@router.post("/entity-203", response_model=HrSchemaEntity203Response, status_code=201)
def create_entity_203(payload: HrSchemaEntity203Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_203(payload)

@router.get("/entity-204", response_model=List[HrSchemaEntity204Response])
...
@router.get("/entity-204/{entity_id}", response_model=HrSchemaEntity204Response)
...
@router.post("/entity-204", response_model=HrSchemaEntity204Response, status_code=201)
def create_entity_204(payload: HrSchemaEntity204Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_204(payload)

@router.get("/entity-205", response_model=List[HrSchemaEntity205Response])
...
@router.get("/entity-205/{entity_id}", response_model=HrSchemaEntity205Response)
...
@router.post("/entity-205", response_model=HrSchemaEntity205Response, status_code=201)
def create_entity_205(payload: HrSchemaEntity205Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_205(payload)

@router.get("/entity-206", response_model=List[HrSchemaEntity206Response])
...
@router.get("/entity-206/{entity_id}", response_model=HrSchemaEntity206Response)
...
@router.post("/entity-206", response_model=HrSchemaEntity206Response, status_code=201)
def create_entity_206(payload: HrSchemaEntity206Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_206(payload)

@router.get("/entity-207", response_model=List[HrSchemaEntity207Response])
...
@router.get("/entity-207/{entity_id}", response_model=HrSchemaEntity207Response)
...
@router.post("/entity-207", response_model=HrSchemaEntity207Response, status_code=201)
def create_entity_207(payload: HrSchemaEntity207Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_207(payload)

@router.get("/entity-208", response_model=List[HrSchemaEntity208Response])
...
@router.get("/entity-208/{entity_id}", response_model=HrSchemaEntity208Response)
...
@router.post("/entity-208", response_model=HrSchemaEntity208Response, status_code=201)
def create_entity_208(payload: HrSchemaEntity208Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_208(payload)

@router.get("/entity-209", response_model=List[HrSchemaEntity209Response])
...
@router.get("/entity-209/{entity_id}", response_model=HrSchemaEntity209Response)
...
@router.post("/entity-209", response_model=HrSchemaEntity209Response, status_code=201)
def create_entity_209(payload: HrSchemaEntity209Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_209(payload)

@router.get("/entity-210", response_model=List[HrSchemaEntity210Response])
...
@router.get("/entity-210/{entity_id}", response_model=HrSchemaEntity210Response)
...
@router.post("/entity-210", response_model=HrSchemaEntity210Response, status_code=201)
def create_entity_210(payload: HrSchemaEntity210Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_210(payload)

@router.get("/entity-211", response_model=List[HrSchemaEntity211Response])
...
@router.get("/entity-211/{entity_id}", response_model=HrSchemaEntity211Response)
...
@router.post("/entity-211", response_model=HrSchemaEntity211Response, status_code=201)
def create_entity_211(payload: HrSchemaEntity211Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_211(payload)

@router.get("/entity-212", response_model=List[HrSchemaEntity212Response])
...
@router.get("/entity-212/{entity_id}", response_model=HrSchemaEntity212Response)
...
@router.post("/entity-212", response_model=HrSchemaEntity212Response, status_code=201)
def create_entity_212(payload: HrSchemaEntity212Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_212(payload)

@router.get("/entity-213", response_model=List[HrSchemaEntity213Response])
...
@router.get("/entity-213/{entity_id}", response_model=HrSchemaEntity213Response)
...
@router.post("/entity-213", response_model=HrSchemaEntity213Response, status_code=201)
def create_entity_213(payload: HrSchemaEntity213Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_213(payload)

@router.get("/entity-214", response_model=List[HrSchemaEntity214Response])
...
@router.get("/entity-214/{entity_id}", response_model=HrSchemaEntity214Response)
...
@router.post("/entity-214", response_model=HrSchemaEntity214Response, status_code=201)
def create_entity_214(payload: HrSchemaEntity214Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_214(payload)

@router.get("/entity-215", response_model=List[HrSchemaEntity215Response])
...
@router.get("/entity-215/{entity_id}", response_model=HrSchemaEntity215Response)
...
@router.post("/entity-215", response_model=HrSchemaEntity215Response, status_code=201)
def create_entity_215(payload: HrSchemaEntity215Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_215(payload)

@router.get("/entity-216", response_model=List[HrSchemaEntity216Response])
...
@router.get("/entity-216/{entity_id}", response_model=HrSchemaEntity216Response)
...
@router.post("/entity-216", response_model=HrSchemaEntity216Response, status_code=201)
def create_entity_216(payload: HrSchemaEntity216Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_216(payload)

@router.get("/entity-217", response_model=List[HrSchemaEntity217Response])
...
@router.get("/entity-217/{entity_id}", response_model=HrSchemaEntity217Response)
...
@router.post("/entity-217", response_model=HrSchemaEntity217Response, status_code=201)
def create_entity_217(payload: HrSchemaEntity217Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_217(payload)

@router.get("/entity-218", response_model=List[HrSchemaEntity218Response])
...
@router.get("/entity-218/{entity_id}", response_model=HrSchemaEntity218Response)
...
@router.post("/entity-218", response_model=HrSchemaEntity218Response, status_code=201)
def create_entity_218(payload: HrSchemaEntity218Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_218(payload)

@router.get("/entity-219", response_model=List[HrSchemaEntity219Response])
...
@router.get("/entity-219/{entity_id}", response_model=HrSchemaEntity219Response)
...
@router.post("/entity-219", response_model=HrSchemaEntity219Response, status_code=201)
def create_entity_219(payload: HrSchemaEntity219Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_219(payload)

@router.get("/entity-220", response_model=List[HrSchemaEntity220Response])
...
@router.get("/entity-220/{entity_id}", response_model=HrSchemaEntity220Response)
...
@router.post("/entity-220", response_model=HrSchemaEntity220Response, status_code=201)
def create_entity_220(payload: HrSchemaEntity220Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_220(payload)

@router.get("/entity-221", response_model=List[HrSchemaEntity221Response])
...
@router.get("/entity-221/{entity_id}", response_model=HrSchemaEntity221Response)
...
@router.post("/entity-221", response_model=HrSchemaEntity221Response, status_code=201)
def create_entity_221(payload: HrSchemaEntity221Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_221(payload)

@router.get("/entity-222", response_model=List[HrSchemaEntity222Response])
...
@router.get("/entity-222/{entity_id}", response_model=HrSchemaEntity222Response)
...
@router.post("/entity-222", response_model=HrSchemaEntity222Response, status_code=201)
def create_entity_222(payload: HrSchemaEntity222Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_222(payload)

@router.get("/entity-223", response_model=List[HrSchemaEntity223Response])
...
@router.get("/entity-223/{entity_id}", response_model=HrSchemaEntity223Response)
...
@router.post("/entity-223", response_model=HrSchemaEntity223Response, status_code=201)
def create_entity_223(payload: HrSchemaEntity223Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_223(payload)

@router.get("/entity-224", response_model=List[HrSchemaEntity224Response])
...
@router.get("/entity-224/{entity_id}", response_model=HrSchemaEntity224Response)
...
@router.post("/entity-224", response_model=HrSchemaEntity224Response, status_code=201)
def create_entity_224(payload: HrSchemaEntity224Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_224(payload)

@router.get("/entity-225", response_model=List[HrSchemaEntity225Response])
...
@router.get("/entity-225/{entity_id}", response_model=HrSchemaEntity225Response)
...
@router.post("/entity-225", response_model=HrSchemaEntity225Response, status_code=201)
def create_entity_225(payload: HrSchemaEntity225Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_225(payload)

@router.get("/entity-226", response_model=List[HrSchemaEntity226Response])
...
@router.get("/entity-226/{entity_id}", response_model=HrSchemaEntity226Response)
...
@router.post("/entity-226", response_model=HrSchemaEntity226Response, status_code=201)
def create_entity_226(payload: HrSchemaEntity226Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_226(payload)

@router.get("/entity-227", response_model=List[HrSchemaEntity227Response])
...
@router.get("/entity-227/{entity_id}", response_model=HrSchemaEntity227Response)
...
@router.post("/entity-227", response_model=HrSchemaEntity227Response, status_code=201)
def create_entity_227(payload: HrSchemaEntity227Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_227(payload)

@router.get("/entity-228", response_model=List[HrSchemaEntity228Response])
...
@router.get("/entity-228/{entity_id}", response_model=HrSchemaEntity228Response)
...
@router.post("/entity-228", response_model=HrSchemaEntity228Response, status_code=201)
def create_entity_228(payload: HrSchemaEntity228Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_228(payload)

@router.get("/entity-229", response_model=List[HrSchemaEntity229Response])
...
@router.get("/entity-229/{entity_id}", response_model=HrSchemaEntity229Response)
...
@router.post("/entity-229", response_model=HrSchemaEntity229Response, status_code=201)
def create_entity_229(payload: HrSchemaEntity229Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_229(payload)

@router.get("/entity-230", response_model=List[HrSchemaEntity230Response])
...
@router.get("/entity-230/{entity_id}", response_model=HrSchemaEntity230Response)
...
@router.post("/entity-230", response_model=HrSchemaEntity230Response, status_code=201)
def create_entity_230(payload: HrSchemaEntity230Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_230(payload)

@router.get("/entity-231", response_model=List[HrSchemaEntity231Response])
...
@router.get("/entity-231/{entity_id}", response_model=HrSchemaEntity231Response)
...
@router.post("/entity-231", response_model=HrSchemaEntity231Response, status_code=201)
def create_entity_231(payload: HrSchemaEntity231Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_231(payload)

@router.get("/entity-232", response_model=List[HrSchemaEntity232Response])
...
@router.get("/entity-232/{entity_id}", response_model=HrSchemaEntity232Response)
...
@router.post("/entity-232", response_model=HrSchemaEntity232Response, status_code=201)
def create_entity_232(payload: HrSchemaEntity232Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_232(payload)

@router.get("/entity-233", response_model=List[HrSchemaEntity233Response])
...
@router.get("/entity-233/{entity_id}", response_model=HrSchemaEntity233Response)
...
@router.post("/entity-233", response_model=HrSchemaEntity233Response, status_code=201)
def create_entity_233(payload: HrSchemaEntity233Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_233(payload)

@router.get("/entity-234", response_model=List[HrSchemaEntity234Response])
...
@router.get("/entity-234/{entity_id}", response_model=HrSchemaEntity234Response)
...
@router.post("/entity-234", response_model=HrSchemaEntity234Response, status_code=201)
def create_entity_234(payload: HrSchemaEntity234Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_234(payload)

@router.get("/entity-235", response_model=List[HrSchemaEntity235Response])
...
@router.get("/entity-235/{entity_id}", response_model=HrSchemaEntity235Response)
...
@router.post("/entity-235", response_model=HrSchemaEntity235Response, status_code=201)
def create_entity_235(payload: HrSchemaEntity235Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_235(payload)

@router.get("/entity-236", response_model=List[HrSchemaEntity236Response])
...
@router.get("/entity-236/{entity_id}", response_model=HrSchemaEntity236Response)
...
@router.post("/entity-236", response_model=HrSchemaEntity236Response, status_code=201)
def create_entity_236(payload: HrSchemaEntity236Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_236(payload)

@router.get("/entity-237", response_model=List[HrSchemaEntity237Response])
...
@router.get("/entity-237/{entity_id}", response_model=HrSchemaEntity237Response)
...
@router.post("/entity-237", response_model=HrSchemaEntity237Response, status_code=201)
def create_entity_237(payload: HrSchemaEntity237Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_237(payload)

@router.get("/entity-238", response_model=List[HrSchemaEntity238Response])
...
@router.get("/entity-238/{entity_id}", response_model=HrSchemaEntity238Response)
...
@router.post("/entity-238", response_model=HrSchemaEntity238Response, status_code=201)
def create_entity_238(payload: HrSchemaEntity238Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_238(payload)

@router.get("/entity-239", response_model=List[HrSchemaEntity239Response])
...
@router.get("/entity-239/{entity_id}", response_model=HrSchemaEntity239Response)
...
@router.post("/entity-239", response_model=HrSchemaEntity239Response, status_code=201)
def create_entity_239(payload: HrSchemaEntity239Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_239(payload)

@router.get("/entity-240", response_model=List[HrSchemaEntity240Response])
...
@router.get("/entity-240/{entity_id}", response_model=HrSchemaEntity240Response)
...
@router.post("/entity-240", response_model=HrSchemaEntity240Response, status_code=201)
def create_entity_240(payload: HrSchemaEntity240Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_240(payload)

@router.get("/entity-241", response_model=List[HrSchemaEntity241Response])
...
@router.get("/entity-241/{entity_id}", response_model=HrSchemaEntity241Response)
...
@router.post("/entity-241", response_model=HrSchemaEntity241Response, status_code=201)
def create_entity_241(payload: HrSchemaEntity241Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_241(payload)

@router.get("/entity-242", response_model=List[HrSchemaEntity242Response])
...
@router.get("/entity-242/{entity_id}", response_model=HrSchemaEntity242Response)
...
@router.post("/entity-242", response_model=HrSchemaEntity242Response, status_code=201)
def create_entity_242(payload: HrSchemaEntity242Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_242(payload)

@router.get("/entity-243", response_model=List[HrSchemaEntity243Response])
...
@router.get("/entity-243/{entity_id}", response_model=HrSchemaEntity243Response)
...
@router.post("/entity-243", response_model=HrSchemaEntity243Response, status_code=201)
def create_entity_243(payload: HrSchemaEntity243Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_243(payload)

@router.get("/entity-244", response_model=List[HrSchemaEntity244Response])
...
@router.get("/entity-244/{entity_id}", response_model=HrSchemaEntity244Response)
...
@router.post("/entity-244", response_model=HrSchemaEntity244Response, status_code=201)
def create_entity_244(payload: HrSchemaEntity244Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_244(payload)

@router.get("/entity-245", response_model=List[HrSchemaEntity245Response])
...
@router.get("/entity-245/{entity_id}", response_model=HrSchemaEntity245Response)
...
@router.post("/entity-245", response_model=HrSchemaEntity245Response, status_code=201)
def create_entity_245(payload: HrSchemaEntity245Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_245(payload)

@router.get("/entity-246", response_model=List[HrSchemaEntity246Response])
...
@router.get("/entity-246/{entity_id}", response_model=HrSchemaEntity246Response)
...
@router.post("/entity-246", response_model=HrSchemaEntity246Response, status_code=201)
def create_entity_246(payload: HrSchemaEntity246Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_246(payload)

@router.get("/entity-247", response_model=List[HrSchemaEntity247Response])
...
@router.get("/entity-247/{entity_id}", response_model=HrSchemaEntity247Response)
...
@router.post("/entity-247", response_model=HrSchemaEntity247Response, status_code=201)
def create_entity_247(payload: HrSchemaEntity247Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_247(payload)

@router.get("/entity-248", response_model=List[HrSchemaEntity248Response])
...
@router.get("/entity-248/{entity_id}", response_model=HrSchemaEntity248Response)
...
@router.post("/entity-248", response_model=HrSchemaEntity248Response, status_code=201)
def create_entity_248(payload: HrSchemaEntity248Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_248(payload)

@router.get("/entity-249", response_model=List[HrSchemaEntity249Response])
...
@router.get("/entity-249/{entity_id}", response_model=HrSchemaEntity249Response)
...
@router.post("/entity-249", response_model=HrSchemaEntity249Response, status_code=201)
def create_entity_249(payload: HrSchemaEntity249Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
    return srv.create_entity_249(payload)

@router.get("/entity-250", response_model=List[HrSchemaEntity250Response])
...
@router.get("/entity-250/{entity_id}", response_model=HrSchemaEntity250Response)
...
@router.post("/entity-250", response_model=HrSchemaEntity250Response, status_code=201)
def create_entity_250(payload: HrSchemaEntity250Create, db: Session = Depends(get_db)):
    srv = HrDomainService(db)
