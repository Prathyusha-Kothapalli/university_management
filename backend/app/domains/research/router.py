"""
Research, Grants & Lab Inventory - FastAPI API Endpoints Router
...
from app.domains.research.schemas import ResearchCreate, ResearchUpdate, ResearchResponse
...
@router.get("/{entity_id}", response_model=ResearchResponse)
...
def create_entity(payload: ResearchCreate, db: Session = Depends(get_db)):
    service = ResearchService(db)
