...
import { IHostelsSubModule6State } from './types';

export const HostelsSubWidget6: React.FC<{ data?: IHostelsSubModule6State }> = ({ data }) => {
  return (
    <div className="p-4 bg-slate-800 rounded-lg border border-slate-700 mb-4">
      <h4 className="text-md font-semibold text-indigo-300">Student Life & Hostel Operations Sub-Component #6</h4>
...
export default HostelsSubWidget6;
