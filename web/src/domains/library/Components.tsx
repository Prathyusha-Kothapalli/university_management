...
export const LibraryComponent1: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #1"}</h3>
...
export const LibraryComponent2: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #2"}</h3>
...
export const LibraryComponent3: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #3"}</h3>
...
export const LibraryComponent4: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #4"}</h3>
...
export const LibraryComponent5: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #5"}</h3>
...
export const LibraryComponent6: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #6"}</h3>
...
export const LibraryComponent7: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #7"}</h3>
...
export const LibraryComponent8: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #8"}</h3>
...
export const LibraryComponent9: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #9"}</h3>
...
export const LibraryComponent10: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #10"}</h3>
...
export const LibraryComponent11: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #11"}</h3>
...
export const LibraryComponent12: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #12"}</h3>
...
export const LibraryComponent13: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #13"}</h3>
...
export const LibraryComponent14: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #14"}</h3>
...
export const LibraryComponent15: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #15"}</h3>
...
export const LibraryComponent16: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #16"}</h3>
...
export const LibraryComponent17: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #17"}</h3>
...
export const LibraryComponent18: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #18"}</h3>
...
export const LibraryComponent19: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #19"}</h3>
...
export const LibraryComponent20: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #20"}</h3>
...
export const LibraryComponent21: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #21"}</h3>
...
export const LibraryComponent22: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #22"}</h3>
...
export const LibraryComponent23: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #23"}</h3>
...
export const LibraryComponent24: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #24"}</h3>
...
export const LibraryComponent25: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #25"}</h3>
...
export const LibraryComponent26: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #26"}</h3>
...
export const LibraryComponent27: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #27"}</h3>
...
export const LibraryComponent28: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #28"}</h3>
...
export const LibraryComponent29: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #29"}</h3>
...
export const LibraryComponent30: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #30"}</h3>
...
export const LibraryComponent31: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #31"}</h3>
...
export const LibraryComponent32: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #32"}</h3>
...
export const LibraryComponent33: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #33"}</h3>
...
export const LibraryComponent34: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #34"}</h3>
...
export const LibraryComponent35: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #35"}</h3>
...
export const LibraryComponent36: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #36"}</h3>
...
export const LibraryComponent37: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #37"}</h3>
...
export const LibraryComponent38: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #38"}</h3>
...
export const LibraryComponent39: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #39"}</h3>
...
export const LibraryComponent40: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #40"}</h3>
...
export const LibraryComponent81: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #81"}</h3>
...
export const LibraryComponent82: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #82"}</h3>
...
export const LibraryComponent83: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #83"}</h3>
...
export const LibraryComponent84: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #84"}</h3>
...
export const LibraryComponent85: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #85"}</h3>
...
export const LibraryComponent86: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #86"}</h3>
...
export const LibraryComponent87: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #87"}</h3>
...
export const LibraryComponent88: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #88"}</h3>
...
export const LibraryComponent89: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #89"}</h3>
...
export const LibraryComponent90: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #90"}</h3>
...
export const LibraryComponent91: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #91"}</h3>
...
export const LibraryComponent92: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #92"}</h3>
...
export const LibraryComponent93: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #93"}</h3>
...
export const LibraryComponent94: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #94"}</h3>
...
export const LibraryComponent95: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #95"}</h3>
...
export const LibraryComponent96: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #96"}</h3>
...
export const LibraryComponent97: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #97"}</h3>
...
export const LibraryComponent98: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #98"}</h3>
...
export const LibraryComponent99: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #99"}</h3>
...
export const LibraryComponent100: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #100"}</h3>
...
export const LibraryComponent101: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #101"}</h3>
...
export const LibraryComponent102: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #102"}</h3>
...
export const LibraryComponent103: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #103"}</h3>
...
export const LibraryComponent104: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #104"}</h3>
...
export const LibraryComponent105: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #105"}</h3>
...
export const LibraryComponent106: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #106"}</h3>
...
export const LibraryComponent107: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #107"}</h3>
...
export const LibraryComponent108: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #108"}</h3>
...
export const LibraryComponent109: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #109"}</h3>
...
export const LibraryComponent110: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #110"}</h3>
...
export const LibraryComponent111: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #111"}</h3>
...
export const LibraryComponent112: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #112"}</h3>
...
export const LibraryComponent113: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #113"}</h3>
...
export const LibraryComponent114: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #114"}</h3>
...
export const LibraryComponent115: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #115"}</h3>
...
export const LibraryComponent116: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #116"}</h3>
...
export const LibraryComponent117: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #117"}</h3>
...
export const LibraryComponent118: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #118"}</h3>
...
export const LibraryComponent119: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #119"}</h3>
...
export const LibraryComponent120: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #120"}</h3>
...
export const LibraryComponent121: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #121"}</h3>
...
export const LibraryComponent122: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #122"}</h3>
...
export const LibraryComponent123: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #123"}</h3>
...
export const LibraryComponent124: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #124"}</h3>
...
export const LibraryComponent125: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #125"}</h3>
...
export const LibraryComponent126: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #126"}</h3>
...
export const LibraryComponent127: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #127"}</h3>
...
export const LibraryComponent128: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #128"}</h3>
...
export const LibraryComponent129: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #129"}</h3>
...
export const LibraryComponent130: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #130"}</h3>
...
export const LibraryComponent131: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #131"}</h3>
...
export const LibraryComponent132: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #132"}</h3>
...
export const LibraryComponent133: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #133"}</h3>
...
export const LibraryComponent134: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #134"}</h3>
...
export const LibraryComponent135: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #135"}</h3>
...
export const LibraryComponent136: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #136"}</h3>
...
export const LibraryComponent137: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #137"}</h3>
...
export const LibraryComponent138: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #138"}</h3>
...
export const LibraryComponent139: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #139"}</h3>
...
export const LibraryComponent140: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #140"}</h3>
...
export const LibraryComponent141: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #141"}</h3>
...
export const LibraryComponent142: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #142"}</h3>
...
export const LibraryComponent143: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #143"}</h3>
...
export const LibraryComponent144: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #144"}</h3>
...
export const LibraryComponent145: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #145"}</h3>
...
export const LibraryComponent146: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #146"}</h3>
...
export const LibraryComponent147: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #147"}</h3>
...
export const LibraryComponent148: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #148"}</h3>
...
export const LibraryComponent149: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #149"}</h3>
...
export const LibraryComponent150: React.FC<{ title?: string }> = ({ title }) => {
  return (
    <div className="p-5 bg-slate-800 border border-slate-700 rounded-xl mb-4">
      <h3 className="text-lg font-bold text-indigo-300">{title || "Library & Digital Repositories Component #150"}</h3>
