"""
Academic & Curriculum Management - FastAPI API Endpoints Router
...
from app.domains.academics.schemas import AcademicsCreate, AcademicsUpdate, AcademicsResponse
...
@router.post("/", response_model=AcademicsResponse)
def create_entity(payload: AcademicsCreate, db: Session = Depends(get_db)):
    service = AcademicsService(db)
