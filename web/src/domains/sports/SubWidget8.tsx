...
import { ISportsSubModule8State } from './types';

export const SportsSubWidget8: React.FC<{ data?: ISportsSubModule8State }> = ({ data }) => {
  return (
    <div className="p-4 bg-slate-800 rounded-lg border border-slate-700 mb-4">
      <h4 className="text-md font-semibold text-indigo-300">Sports & Extracurricular Activities Sub-Component #8</h4>
...
export default SportsSubWidget8;
