"""
Human Resources & Faculty Management - FastAPI API Endpoints Router
...
from app.domains.hr.schemas import HrCreate, HrUpdate, HrResponse
...
@router.get("/{entity_id}", response_model=HrResponse)
...
def create_entity(payload: HrCreate, db: Session = Depends(get_db)):
    service = HrService(db)
