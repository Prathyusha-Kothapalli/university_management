...
import { IHrSubModule4State } from './types';

export const HrSubWidget4: React.FC<{ data?: IHrSubModule4State }> = ({ data }) => {
  return (
    <div className="p-4 bg-slate-800 rounded-lg border border-slate-700 mb-4">
      <h4 className="text-md font-semibold text-indigo-300">Human Resources & Faculty Management Sub-Component #4</h4>
