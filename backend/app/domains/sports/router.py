"""
Sports & Extracurricular Activities - FastAPI API Endpoints Router
...
from app.domains.sports.schemas import SportsCreate, SportsUpdate, SportsResponse
...
@router.post("/", response_model=SportsResponse)
def create_entity(payload: SportsCreate, db: Session = Depends(get_db)):
    service = SportsService(db)
