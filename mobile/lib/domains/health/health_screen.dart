...
class HealthMainScreen extends StatefulWidget {
  const HealthMainScreen({Key? key}) : super(key: key);
  @override
        ...
        itemBuilder: (context, index) {
          return Card(
            ...
            child: ListTile(
              ...
              title: Text("Campus Health & Clinic Management Record #${index + 1}", style: const TextStyle(fontWeight: FontWeight.bold)),
              subtitle: Text("Code: HEALTH-M-${index + 100}"),
