...
@router.get("/entity-201", response_model=List[FinanceSchemaEntity201Response])
...
@router.get("/entity-201/{entity_id}", response_model=FinanceSchemaEntity201Response)
...
@router.post("/entity-201", response_model=FinanceSchemaEntity201Response, status_code=201)
def create_entity_201(payload: FinanceSchemaEntity201Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_201(payload)

@router.get("/entity-202", response_model=List[FinanceSchemaEntity202Response])
...
@router.get("/entity-202/{entity_id}", response_model=FinanceSchemaEntity202Response)
...
@router.post("/entity-202", response_model=FinanceSchemaEntity202Response, status_code=201)
def create_entity_202(payload: FinanceSchemaEntity202Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_202(payload)

@router.get("/entity-203", response_model=List[FinanceSchemaEntity203Response])
...
@router.get("/entity-203/{entity_id}", response_model=FinanceSchemaEntity203Response)
...
@router.post("/entity-203", response_model=FinanceSchemaEntity203Response, status_code=201)
def create_entity_203(payload: FinanceSchemaEntity203Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_203(payload)

@router.get("/entity-204", response_model=List[FinanceSchemaEntity204Response])
...
@router.get("/entity-204/{entity_id}", response_model=FinanceSchemaEntity204Response)
...
@router.post("/entity-204", response_model=FinanceSchemaEntity204Response, status_code=201)
def create_entity_204(payload: FinanceSchemaEntity204Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_204(payload)

@router.get("/entity-205", response_model=List[FinanceSchemaEntity205Response])
...
@router.get("/entity-205/{entity_id}", response_model=FinanceSchemaEntity205Response)
...
@router.post("/entity-205", response_model=FinanceSchemaEntity205Response, status_code=201)
def create_entity_205(payload: FinanceSchemaEntity205Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_205(payload)

@router.get("/entity-206", response_model=List[FinanceSchemaEntity206Response])
...
@router.get("/entity-206/{entity_id}", response_model=FinanceSchemaEntity206Response)
...
@router.post("/entity-206", response_model=FinanceSchemaEntity206Response, status_code=201)
def create_entity_206(payload: FinanceSchemaEntity206Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_206(payload)

@router.get("/entity-207", response_model=List[FinanceSchemaEntity207Response])
...
@router.get("/entity-207/{entity_id}", response_model=FinanceSchemaEntity207Response)
...
@router.post("/entity-207", response_model=FinanceSchemaEntity207Response, status_code=201)
def create_entity_207(payload: FinanceSchemaEntity207Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_207(payload)

@router.get("/entity-208", response_model=List[FinanceSchemaEntity208Response])
...
@router.get("/entity-208/{entity_id}", response_model=FinanceSchemaEntity208Response)
...
@router.post("/entity-208", response_model=FinanceSchemaEntity208Response, status_code=201)
def create_entity_208(payload: FinanceSchemaEntity208Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_208(payload)

@router.get("/entity-209", response_model=List[FinanceSchemaEntity209Response])
...
@router.get("/entity-209/{entity_id}", response_model=FinanceSchemaEntity209Response)
...
@router.post("/entity-209", response_model=FinanceSchemaEntity209Response, status_code=201)
def create_entity_209(payload: FinanceSchemaEntity209Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_209(payload)

@router.get("/entity-210", response_model=List[FinanceSchemaEntity210Response])
...
@router.get("/entity-210/{entity_id}", response_model=FinanceSchemaEntity210Response)
...
@router.post("/entity-210", response_model=FinanceSchemaEntity210Response, status_code=201)
def create_entity_210(payload: FinanceSchemaEntity210Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_210(payload)

@router.get("/entity-211", response_model=List[FinanceSchemaEntity211Response])
...
@router.get("/entity-211/{entity_id}", response_model=FinanceSchemaEntity211Response)
...
@router.post("/entity-211", response_model=FinanceSchemaEntity211Response, status_code=201)
def create_entity_211(payload: FinanceSchemaEntity211Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_211(payload)

@router.get("/entity-212", response_model=List[FinanceSchemaEntity212Response])
...
@router.get("/entity-212/{entity_id}", response_model=FinanceSchemaEntity212Response)
...
@router.post("/entity-212", response_model=FinanceSchemaEntity212Response, status_code=201)
def create_entity_212(payload: FinanceSchemaEntity212Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_212(payload)

@router.get("/entity-213", response_model=List[FinanceSchemaEntity213Response])
...
@router.get("/entity-213/{entity_id}", response_model=FinanceSchemaEntity213Response)
...
@router.post("/entity-213", response_model=FinanceSchemaEntity213Response, status_code=201)
def create_entity_213(payload: FinanceSchemaEntity213Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_213(payload)

@router.get("/entity-214", response_model=List[FinanceSchemaEntity214Response])
...
@router.get("/entity-214/{entity_id}", response_model=FinanceSchemaEntity214Response)
...
@router.post("/entity-214", response_model=FinanceSchemaEntity214Response, status_code=201)
def create_entity_214(payload: FinanceSchemaEntity214Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_214(payload)

@router.get("/entity-215", response_model=List[FinanceSchemaEntity215Response])
...
@router.get("/entity-215/{entity_id}", response_model=FinanceSchemaEntity215Response)
...
@router.post("/entity-215", response_model=FinanceSchemaEntity215Response, status_code=201)
def create_entity_215(payload: FinanceSchemaEntity215Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_215(payload)

@router.get("/entity-216", response_model=List[FinanceSchemaEntity216Response])
...
@router.get("/entity-216/{entity_id}", response_model=FinanceSchemaEntity216Response)
...
@router.post("/entity-216", response_model=FinanceSchemaEntity216Response, status_code=201)
def create_entity_216(payload: FinanceSchemaEntity216Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_216(payload)

@router.get("/entity-217", response_model=List[FinanceSchemaEntity217Response])
...
@router.get("/entity-217/{entity_id}", response_model=FinanceSchemaEntity217Response)
...
@router.post("/entity-217", response_model=FinanceSchemaEntity217Response, status_code=201)
def create_entity_217(payload: FinanceSchemaEntity217Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_217(payload)

@router.get("/entity-218", response_model=List[FinanceSchemaEntity218Response])
...
@router.get("/entity-218/{entity_id}", response_model=FinanceSchemaEntity218Response)
...
@router.post("/entity-218", response_model=FinanceSchemaEntity218Response, status_code=201)
def create_entity_218(payload: FinanceSchemaEntity218Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_218(payload)

@router.get("/entity-219", response_model=List[FinanceSchemaEntity219Response])
...
@router.get("/entity-219/{entity_id}", response_model=FinanceSchemaEntity219Response)
...
@router.post("/entity-219", response_model=FinanceSchemaEntity219Response, status_code=201)
def create_entity_219(payload: FinanceSchemaEntity219Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_219(payload)

@router.get("/entity-220", response_model=List[FinanceSchemaEntity220Response])
...
@router.get("/entity-220/{entity_id}", response_model=FinanceSchemaEntity220Response)
...
@router.post("/entity-220", response_model=FinanceSchemaEntity220Response, status_code=201)
def create_entity_220(payload: FinanceSchemaEntity220Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_220(payload)

@router.get("/entity-221", response_model=List[FinanceSchemaEntity221Response])
...
@router.get("/entity-221/{entity_id}", response_model=FinanceSchemaEntity221Response)
...
@router.post("/entity-221", response_model=FinanceSchemaEntity221Response, status_code=201)
def create_entity_221(payload: FinanceSchemaEntity221Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_221(payload)

@router.get("/entity-222", response_model=List[FinanceSchemaEntity222Response])
...
@router.get("/entity-222/{entity_id}", response_model=FinanceSchemaEntity222Response)
...
@router.post("/entity-222", response_model=FinanceSchemaEntity222Response, status_code=201)
def create_entity_222(payload: FinanceSchemaEntity222Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_222(payload)

@router.get("/entity-223", response_model=List[FinanceSchemaEntity223Response])
...
@router.get("/entity-223/{entity_id}", response_model=FinanceSchemaEntity223Response)
...
@router.post("/entity-223", response_model=FinanceSchemaEntity223Response, status_code=201)
def create_entity_223(payload: FinanceSchemaEntity223Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_223(payload)

@router.get("/entity-224", response_model=List[FinanceSchemaEntity224Response])
...
@router.get("/entity-224/{entity_id}", response_model=FinanceSchemaEntity224Response)
...
@router.post("/entity-224", response_model=FinanceSchemaEntity224Response, status_code=201)
def create_entity_224(payload: FinanceSchemaEntity224Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_224(payload)

@router.get("/entity-225", response_model=List[FinanceSchemaEntity225Response])
...
@router.get("/entity-225/{entity_id}", response_model=FinanceSchemaEntity225Response)
...
@router.post("/entity-225", response_model=FinanceSchemaEntity225Response, status_code=201)
def create_entity_225(payload: FinanceSchemaEntity225Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_225(payload)

@router.get("/entity-226", response_model=List[FinanceSchemaEntity226Response])
...
@router.get("/entity-226/{entity_id}", response_model=FinanceSchemaEntity226Response)
...
@router.post("/entity-226", response_model=FinanceSchemaEntity226Response, status_code=201)
def create_entity_226(payload: FinanceSchemaEntity226Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_226(payload)

@router.get("/entity-227", response_model=List[FinanceSchemaEntity227Response])
...
@router.get("/entity-227/{entity_id}", response_model=FinanceSchemaEntity227Response)
...
@router.post("/entity-227", response_model=FinanceSchemaEntity227Response, status_code=201)
def create_entity_227(payload: FinanceSchemaEntity227Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_227(payload)

@router.get("/entity-228", response_model=List[FinanceSchemaEntity228Response])
...
@router.get("/entity-228/{entity_id}", response_model=FinanceSchemaEntity228Response)
...
@router.post("/entity-228", response_model=FinanceSchemaEntity228Response, status_code=201)
def create_entity_228(payload: FinanceSchemaEntity228Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_228(payload)

@router.get("/entity-229", response_model=List[FinanceSchemaEntity229Response])
...
@router.get("/entity-229/{entity_id}", response_model=FinanceSchemaEntity229Response)
...
@router.post("/entity-229", response_model=FinanceSchemaEntity229Response, status_code=201)
def create_entity_229(payload: FinanceSchemaEntity229Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_229(payload)

@router.get("/entity-230", response_model=List[FinanceSchemaEntity230Response])
...
@router.get("/entity-230/{entity_id}", response_model=FinanceSchemaEntity230Response)
...
@router.post("/entity-230", response_model=FinanceSchemaEntity230Response, status_code=201)
def create_entity_230(payload: FinanceSchemaEntity230Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_230(payload)

@router.get("/entity-231", response_model=List[FinanceSchemaEntity231Response])
...
@router.get("/entity-231/{entity_id}", response_model=FinanceSchemaEntity231Response)
...
@router.post("/entity-231", response_model=FinanceSchemaEntity231Response, status_code=201)
def create_entity_231(payload: FinanceSchemaEntity231Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_231(payload)

@router.get("/entity-232", response_model=List[FinanceSchemaEntity232Response])
...
@router.get("/entity-232/{entity_id}", response_model=FinanceSchemaEntity232Response)
...
@router.post("/entity-232", response_model=FinanceSchemaEntity232Response, status_code=201)
def create_entity_232(payload: FinanceSchemaEntity232Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_232(payload)

@router.get("/entity-233", response_model=List[FinanceSchemaEntity233Response])
...
@router.get("/entity-233/{entity_id}", response_model=FinanceSchemaEntity233Response)
...
@router.post("/entity-233", response_model=FinanceSchemaEntity233Response, status_code=201)
def create_entity_233(payload: FinanceSchemaEntity233Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_233(payload)

@router.get("/entity-234", response_model=List[FinanceSchemaEntity234Response])
...
@router.get("/entity-234/{entity_id}", response_model=FinanceSchemaEntity234Response)
...
@router.post("/entity-234", response_model=FinanceSchemaEntity234Response, status_code=201)
def create_entity_234(payload: FinanceSchemaEntity234Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_234(payload)

@router.get("/entity-235", response_model=List[FinanceSchemaEntity235Response])
...
@router.get("/entity-235/{entity_id}", response_model=FinanceSchemaEntity235Response)
...
@router.post("/entity-235", response_model=FinanceSchemaEntity235Response, status_code=201)
def create_entity_235(payload: FinanceSchemaEntity235Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_235(payload)

@router.get("/entity-236", response_model=List[FinanceSchemaEntity236Response])
...
@router.get("/entity-236/{entity_id}", response_model=FinanceSchemaEntity236Response)
...
@router.post("/entity-236", response_model=FinanceSchemaEntity236Response, status_code=201)
def create_entity_236(payload: FinanceSchemaEntity236Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_236(payload)

@router.get("/entity-237", response_model=List[FinanceSchemaEntity237Response])
...
@router.get("/entity-237/{entity_id}", response_model=FinanceSchemaEntity237Response)
...
@router.post("/entity-237", response_model=FinanceSchemaEntity237Response, status_code=201)
def create_entity_237(payload: FinanceSchemaEntity237Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_237(payload)

@router.get("/entity-238", response_model=List[FinanceSchemaEntity238Response])
...
@router.get("/entity-238/{entity_id}", response_model=FinanceSchemaEntity238Response)
...
@router.post("/entity-238", response_model=FinanceSchemaEntity238Response, status_code=201)
def create_entity_238(payload: FinanceSchemaEntity238Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_238(payload)

@router.get("/entity-239", response_model=List[FinanceSchemaEntity239Response])
...
@router.get("/entity-239/{entity_id}", response_model=FinanceSchemaEntity239Response)
...
@router.post("/entity-239", response_model=FinanceSchemaEntity239Response, status_code=201)
def create_entity_239(payload: FinanceSchemaEntity239Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_239(payload)

@router.get("/entity-240", response_model=List[FinanceSchemaEntity240Response])
...
@router.get("/entity-240/{entity_id}", response_model=FinanceSchemaEntity240Response)
...
@router.post("/entity-240", response_model=FinanceSchemaEntity240Response, status_code=201)
def create_entity_240(payload: FinanceSchemaEntity240Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_240(payload)

@router.get("/entity-241", response_model=List[FinanceSchemaEntity241Response])
...
@router.get("/entity-241/{entity_id}", response_model=FinanceSchemaEntity241Response)
...
@router.post("/entity-241", response_model=FinanceSchemaEntity241Response, status_code=201)
def create_entity_241(payload: FinanceSchemaEntity241Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_241(payload)

@router.get("/entity-242", response_model=List[FinanceSchemaEntity242Response])
...
@router.get("/entity-242/{entity_id}", response_model=FinanceSchemaEntity242Response)
...
@router.post("/entity-242", response_model=FinanceSchemaEntity242Response, status_code=201)
def create_entity_242(payload: FinanceSchemaEntity242Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_242(payload)

@router.get("/entity-243", response_model=List[FinanceSchemaEntity243Response])
...
@router.get("/entity-243/{entity_id}", response_model=FinanceSchemaEntity243Response)
...
@router.post("/entity-243", response_model=FinanceSchemaEntity243Response, status_code=201)
def create_entity_243(payload: FinanceSchemaEntity243Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_243(payload)

@router.get("/entity-244", response_model=List[FinanceSchemaEntity244Response])
...
@router.get("/entity-244/{entity_id}", response_model=FinanceSchemaEntity244Response)
...
@router.post("/entity-244", response_model=FinanceSchemaEntity244Response, status_code=201)
def create_entity_244(payload: FinanceSchemaEntity244Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_244(payload)

@router.get("/entity-245", response_model=List[FinanceSchemaEntity245Response])
...
@router.get("/entity-245/{entity_id}", response_model=FinanceSchemaEntity245Response)
...
@router.post("/entity-245", response_model=FinanceSchemaEntity245Response, status_code=201)
def create_entity_245(payload: FinanceSchemaEntity245Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_245(payload)

@router.get("/entity-246", response_model=List[FinanceSchemaEntity246Response])
...
@router.get("/entity-246/{entity_id}", response_model=FinanceSchemaEntity246Response)
...
@router.post("/entity-246", response_model=FinanceSchemaEntity246Response, status_code=201)
def create_entity_246(payload: FinanceSchemaEntity246Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_246(payload)

@router.get("/entity-247", response_model=List[FinanceSchemaEntity247Response])
...
@router.get("/entity-247/{entity_id}", response_model=FinanceSchemaEntity247Response)
...
@router.post("/entity-247", response_model=FinanceSchemaEntity247Response, status_code=201)
def create_entity_247(payload: FinanceSchemaEntity247Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_247(payload)

@router.get("/entity-248", response_model=List[FinanceSchemaEntity248Response])
...
@router.get("/entity-248/{entity_id}", response_model=FinanceSchemaEntity248Response)
...
@router.post("/entity-248", response_model=FinanceSchemaEntity248Response, status_code=201)
def create_entity_248(payload: FinanceSchemaEntity248Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_248(payload)

@router.get("/entity-249", response_model=List[FinanceSchemaEntity249Response])
...
@router.get("/entity-249/{entity_id}", response_model=FinanceSchemaEntity249Response)
...
@router.post("/entity-249", response_model=FinanceSchemaEntity249Response, status_code=201)
def create_entity_249(payload: FinanceSchemaEntity249Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
    return srv.create_entity_249(payload)

@router.get("/entity-250", response_model=List[FinanceSchemaEntity250Response])
...
@router.get("/entity-250/{entity_id}", response_model=FinanceSchemaEntity250Response)
...
@router.post("/entity-250", response_model=FinanceSchemaEntity250Response, status_code=201)
def create_entity_250(payload: FinanceSchemaEntity250Create, db: Session = Depends(get_db)):
    srv = FinanceDomainService(db)
